...
int main() {
	{
		...
		std::cout << NPURPLE << "--------------------------------------------------------------"
				  << RESET << std::endl;
		for (MutantStack<int>::const_it c_it = mstack.begin(); c_it != mstack.end(); c_it++)
		...
		std::cout << NPURPLE << "--------------------------------------------------------------"
				  << RESET << std::endl;
		for (MutantStack<int>::rev_it rev_it = mstack.rbegin(); rev_it != mstack.rend(); rev_it++)
			std::cout << NGREEN << "[" << *rev_it << "]" << RESET << std::endl;
		std::cout << NPURPLE << "--------------------------------------------------------------"
				  << RESET << std::endl;
		std::cout << std::endl;

		std::cout << NGREEN << "testing const revers iterators" << RESET << std::endl;
		std::cout << NPURPLE << "--------------------------------------------------------------"
				  << RESET << std::endl;
	...
	std::cout << NPURPLE << "--------------------------------------------------------------" << RESET << std::endl;
	{
		...
		std::cout << NPURPLE << "--------------------------------------------------------------"
				  << RESET << std::endl;
		for (std::vector<int>::iterator it = mstack.begin(); it != mstack.end(); it++)
			std::cout << NGREEN << "[" << *it << "]" << RESET << std::endl;
		std::cout << NPURPLE << "--------------------------------------------------------------"
				  << RESET << std::endl;
		std::cout << std::endl;
		...
		std::cout << NPURPLE << "--------------------------------------------------------------"
				  << RESET << std::endl;
		for (std::vector<int>::const_iterator c_it = mstack.begin(); c_it != mstack.end(); c_it++)
			std::cout << NGREEN << "[" << *c_it << "]" << RESET << std::endl;
		std::cout << NPURPLE << "--------------------------------------------------------------"
				  << RESET << std::endl;
		std::cout << std::endl;
		...
		std::cout << NPURPLE << "--------------------------------------------------------------"
				  << RESET << std::endl;
		for (std::vector<int>::const_reverse_iterator const_rev_it = mstack.rbegin();
			 const_rev_it != mstack.rend(); const_rev_it++)
			std::cout << NGREEN << "[" << *const_rev_it << "]" << RESET << std::endl;
		std::cout << NPURPLE << "--------------------------------------------------------------"
				  << RESET << std::endl;
